...
export const Header = () => {
  ...
  <header className="py-4 border-b border-white/15 md:border-none sticky top-0 z-10">
    <div role='backdrop blur div element' className='absolute inset-0 backdrop-blur-md -z-10 md:hidden'></div>
    <div className="container">
      <div className="flex justify-between items-center md:border border-white/15 md:p-2.5 rounded-xl max-w-2xl mx-auto relative">
        <div role='backdrop blur div element' className='absolute inset-0 backdrop-blur-md -z-10 hidden md:block'> </div>
        <div>
